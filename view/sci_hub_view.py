...
class SciHubView:
    start_text = ("Send me a *science direct* url, "
                  "I will fetch the paper and upload it for you here, otherwise I won't respond :D")
    ...
    def send_paper(self, chat_id, file, title):
        ...
        self.bot.send_document(chat_id, document=file, caption=title, reply_markup=markup_keyboard)
